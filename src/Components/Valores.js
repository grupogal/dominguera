...
class Valores extends Component{
    ...
    render(){
        ...
        return(
                ...
                <section title='Descripción de la hacienda' className = 'flex flex-row justify-between max-h-screen mb-8'>
                    ...
                    <div title='imagen' className='flex flex-col w-1/2 pl-8' >
                        <div className='flex flex-row justify-between mt-16 mb-2 pr-8'>
                            <img alt='' src={img2} className='object-scale  w-full pr-4 pt-40 h-halfScreen '/>
                            <img alt='' src = {img3} className='object-scale  w-full pt-40 h-halfScreen'/>
                        </div>
                        <div>
                         <img alt='' src={img} className='object-scale  w-full pr-8 h-halfScreen pb-40' title='Imagen de arbol hacienda'/>
                        </div>
            ...
            return(
                <div>
                    <section title='Descripción de la hacienda' className = 'flex flex-col justify-between  mb-8 mt-12'>
                        ...
                        <div title='imagen' className='flex flex-col w-full pl-1' >
                            ...
                            <img alt='' src={img2} className='object-scale   pr-1 md:h-halfScreen sm:h-1/2 sm:w-1/2 lg:h-haflScreen lg:w-1/2 w-48 h-48'/>
                            <img alt='' src = {img3} className='object-scale md:h-halfScreen sm:h-1/2 sm:w-1/2 lg:h-haflScreen lg:w-1/2 w-48 h-48'/>
                            </div>
                            <div>
                             <img alt='' src={img} className='object-contain w-full pt-4 pb-40 pr-1' title='Imagen de arbol hacienda'/>
                            </div>
