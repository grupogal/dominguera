            ...
            <div >
                ...
                <section className='flex flex-col w-3/5'>
                    <div className='flex flex-row'>
                        <img alt='' src={img1} alt='' className='object-contain p-2'/>
                        <img alt='' src={img2} alt='' className='object-contain p-2'/>
                    </div>
                    <div className='flex flex-row'>
                        <img alt='' src={img3} alt='' className='object-contain p-2'/>
                        <img alt='' src={img4} alt='' className='object-contain p-2'/>
                    </div>
                </section>
                </div>
            </div>
